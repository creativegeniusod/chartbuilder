...
var typeOptions = [
	...
	{ title: "Scatter", content: "Scatter", value: "scatterPlot" }
];
...
var XYEditor = React.createClass({
	...
	render: function() {
		...
		*/
		...
		var a = (this.props.errors.messages.filter(function(e) {
            return "axis" === e.location
		}), this.props.errors.messages.filter(function(e) {
			return "NO_PREFIX_SUFFIX" === e.name
		}));
		
		var o = this.props.errors.messages.filter(function(e) {
			return "UNEVEN_TICKS" === e.name
		});
		...
		if (chartProps._numSecondaryAxis > 0) {
			scaleSettings.push(
				<XY_yScaleSettings
					...
					errors={axisErrors}
					onReset={this._handlePropAndReparse.bind(null, "scale")}
					className="scale-options secondary-scale"
					id="secondaryScale"
					name="Secondary"
					stepNumber="4+"
					key="secondaryScale"
