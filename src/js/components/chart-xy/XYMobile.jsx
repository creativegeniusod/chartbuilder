	...
	render: function() {
		...
		scaleSettings.push(
			<XY_yScaleSettings
				...
				name="Primary"
				key="primaryScale"
				titleOverride="Mobile-specific y-axis settings"
				stepNumber = ""
			/>
		);
		...
		return (
			<div className="editor-options mobile-overrides">
				...
				<span className="helptext">Be sure to check that your chart is rendering correctly at smaller sizes. Scroll the left side of the page to preview the mobile chart size.</span>
				<TextInput
