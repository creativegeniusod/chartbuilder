...
var ChartExport = React.createClass({
	...
	downloadPNG: function() {
		console.log(this.state.chartNode);
	...
	render: function() {
		...
		if(this.props.additionalComponents.deleteButton){
		    chartExportButtons.push(this.props.additionalComponents.deleteButton);
		}
		
		var advanced_option = "advanced-options ";
		
		if(this.state.showAdvancedOptions === true){
			advanced_option = "";
		}else{
		    advanced_option += " hidden";
		}
		...
		var advanvedOptionLabel = '';
		if(this.state.showAdvancedOptions === true){
			advanvedOptionLabel = 'Close advanced option';
		}else{
			advanvedOptionLabel = 'Advanced option';
		}

		return (
			<div className="editor-options">
				<h2><span className="step-number">{this.props.stepNumber}</span><span>Export your chart</span></h2>
				<h4 className="toggle-advanced" onClick={this.setAdvancedOptionState}>{advanvedOptionLabel}</h4>
				<div className={advanced_option}>
					{this.props.additionalComponents.advancedOptions}
