...
var CreditLogo = require("./Logo.jsx");
	...
	render: function() {
		...
		svgLogo = ( 
			<CreditLogo
					...
					translate={[this.props.translate.left, this.props.translate.bottom - this.state.creditDimensions.height]}
					onUpdate={this._handleStateUpdate.bind(null, "creditDimensions")}
			/> 
		);
